...
export const GDP_COMPARE = compareSeries(
  [
    { name: 'Indien', pts: [[1970, 0.10], [1980, 0.15], [1990, 0.24], [2000, 0.42], [2010, 0.71], [2015, 1.0], [2019, 1.3], [2020, 1.22], [2022, 1.45], [2024, 1.65]] },
    { name: 'China', pts: [[1970, 0.03], [1980, 0.05], [1990, 0.12], [2000, 0.33], [2010, 0.73], [2015, 1.0], [2019, 1.28], [2020, 1.31], [2022, 1.42], [2024, 1.55]] },
    { name: 'USA', pts: [[1970, 0.33], [1980, 0.44], [1990, 0.58], [2000, 0.78], [2010, 0.9], [2015, 1.0], [2019, 1.1], [2020, 1.07], [2022, 1.18], [2024, 1.25]] },
    { name: 'Deutschland', pts: [[1970, 0.55], [1980, 0.68], [1990, 0.80], [2000, 0.86], [2010, 0.94], [2015, 1.0], [2017, 1.05], [2019, 1.08], [2020, 1.03], [2022, 1.09], [2023, 1.09], [2024, 1.08]] },
    { name: 'Japan', pts: [[1970, 0.34], [1980, 0.52], [1990, 0.78], [2000, 0.90], [2010, 0.95], [2015, 1.0], [2019, 1.03], [2020, 0.99], [2022, 1.02], [2024, 1.02]] },
  ],
  (v) => `${v.toFixed(1)}×`,
